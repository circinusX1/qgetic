...
void  CUndo::Add(Brush* pB, u_int32_t action)
{
    return;
    if(_fromHere)
        return;
...
void  CUndo::Add(SceItem* pB, u_int32_t action)
{
    return;
/*
    if(_fromHere)
...
void  CUndo::Undo(Document* pDoc,  u_int32_t action)
{
    return;
    _fromHere = 1;
    if(_records.size())
...
void  CUndo::_UndoBrush(Document* pDoc, const Record& rec)
{
    return;
    if(rec.p_Obj0)
    {
...
void  CUndo::_UndoItem(Document* pDoc, const Record& rec)
{
    /*
    if(rec.p_Obj0)
    {
